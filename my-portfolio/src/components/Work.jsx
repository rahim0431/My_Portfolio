...
const projects = [
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}chat_register.jpg`,
      `${import.meta.env.BASE_URL}chat_login.jpg`,
      `${import.meta.env.BASE_URL}chat_msg.jpg`,
      `${import.meta.env.BASE_URL}chat_profile.jpg`,
      `${import.meta.env.BASE_URL}chat_ai.jpg`,
      `${import.meta.env.BASE_URL}chat_settings.jpg`,
      `${import.meta.env.BASE_URL}chat_themes.jpg`,
    ],
